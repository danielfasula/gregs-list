...
export default class Car {
  ...
  get Template() {
    return /*html*/`<div class="card mt-5 col-8 col-lg-3 mx-3">
  <i class="fa fa-trash fa-2x text-danger d-flex align-self-end pointer mt-2" onclick="app.carsController.deleteCar('${this.id}')" aria-hidden="true"></i>
